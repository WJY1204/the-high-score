...
namespace DA_Assets.FCU.Config
{
    public class FCU_Config : SingletoneScriptableObject<FCU_Config>
    {
        ...
        [SerializeField] List<FigmaAligment> aligmentConfigs;
        ...
        private string tgLink = "https://t.me/da_assets_publisher";
        private string compressAssetsOnImportPrefsKey = "kCompressTexturesOnImport";
        private char realTagSeparator = '-';
        private string apiLink = "https://api.figma.com/v1/files/{0}?geometry=paths";
        private string clientId = "LaB1ONuPoY7QCdfshDbQbT";
        private string clientSecret = "E9PblceydtAyE7Onhg5FHLmnvingDp";
        private string redirectUri = "http://localhost:1923/";
        private string authUrl = "https://www.figma.com/api/oauth/token?client_id={0}&client_secret={1}&redirect_uri={2}&code={3}&grant_type=authorization_code";
        private string oAuthUrl = "https://www.figma.com/oauth?client_id={0}&redirect_uri={1}&scope=file_read&state={2}&response_type=code";

        private float delay0001 = 0.001f;
        private float delay001 = 0.01f;
        private float delay01 = 0.1f;
        ...
        public float Delay0001 { get => delay0001; }
        ...
        public List<FigmaAligment> AligmentConfigs { get => aligmentConfigs; set => aligmentConfigs = value; }
