...
namespace DA_Assets.FCU
{
    ...
    internal class FCU_Editor : Editor
    {
                ...
                Body = () =>
                {
                    ...
                    switch (fcu.Model.MainSettings.ImageComponent)
                    {
                        case ImageComponent.UnityImage:
                            DrawUnityImageSettings();
                            break;
                        case ImageComponent.Shape:
                            DrawShapes2D_Settings();
                            break;
                ...
                Body = () =>
                {
                    ...
                    gui.DrawGroup(new Group
                    {
                        ...
                        Body = () =>
                        {
                            ...
                            gui.Label(new GUIContent($"{Mathf.Round(fcu.WebClient.PbarBytes / 1024)} kB", LocKey.label_kilobytes.Localize()), 10, LabelWidthType.Option);
                            GUILayout.Space(gui.SMALL_SPACE);
                            gui.Label(new GUIContent("—"), 10, LabelWidthType.Option);
                            ...
                            {
                                GUILayout.Space(gui.SMALL_SPACE);
                                gui.Label(new GUIContent(userName, LocKey.label_user_name.Localize()), 10, LabelWidthType.Option);
                                GUILayout.Space(gui.SMALL_SPACE);
                                gui.Label(new GUIContent("—"), 10, LabelWidthType.Option);
                            }
                            ...
                            {
                                GUILayout.Space(gui.SMALL_SPACE);
                                gui.Label(new GUIContent(userId, LocKey.tooltip_user_id.Localize()), 10, LabelWidthType.Option);
                                GUILayout.Space(gui.SMALL_SPACE);
                                gui.Label(new GUIContent("—"), 10, LabelWidthType.Option);
                            }

                            GUILayout.Space(gui.SMALL_SPACE);
                            gui.Label(new GUIContent(fcu.Model.Guid, LocKey.tooltip_asset_instance_id.Localize()), 10, LabelWidthType.Option);
                            GUILayout.Space(gui.SMALL_SPACE);
                            gui.Label(new GUIContent("—"), 10, LabelWidthType.Option);
                            GUILayout.Space(gui.SMALL_SPACE);
                            gui.Label(new GUIContent(FCU_Config.Instance.ProductVersion, LocKey.tooltip_product_version.Localize()), 10, LabelWidthType.Option);
                        }
                    });
                    ...
                    if (currentProjectName != null)
                    {
                        gui.DrawGroup(new Group
                        {
                            ...
                            {
                                GUILayout.FlexibleSpace();
                                gui.Label(new GUIContent(currentProjectName), 10, LabelWidthType.Option);
                            }
                        });
                    }
                }
        ...
        private void ShowRecentProjectsPopup()
        {
            ...
            {
                gui.Button(new GUIContent(LocKey.label_no_recent_projects.Localize()));
            }
            ...
            gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
            {
                ...
                Body = () =>
                {
                    ...
                    FCU_Config.Instance.Language = gui.EnumField(
                        ...
                        FCU_Config.Instance.Language, uppercase: true, itemNames: new string[] { FCU_Config.Instance.AssetLanguageNames[0] });
                }
            });
        }
                                ...
                                Body = () =>
                                {
                                    for (int i = 0; i < page.Count(); i++)
                                    {
                                        page.ToList()[i].Selected =
                                            gui.CheckBox(new GUIContent(page.ToList()[i].Name), page.ToList()[i].Selected, 78);
                                    }
                                },
        ...
        private void DrawPUI_Settings()
        {
            ...
            gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
            {
                ...
                Body = () =>
                {
                    fcu.Model.PUI_Settings.Type = gui.EnumField(new GUIContent(LocKey.label_pui_type.Localize(), ""),
                        fcu.Model.PUI_Settings.Type);

                    fcu.Model.PUI_Settings.RaycastTarget = gui.Toggle(new GUIContent(LocKey.label_pui_raycast_target.Localize(), ""),
                        fcu.Model.PUI_Settings.RaycastTarget);

                    fcu.Model.PUI_Settings.FalloffDistance = gui.FloatField(new GUIContent(LocKey.label_pui_falloff_distance.Localize(), ""),
                        fcu.Model.PUI_Settings.FalloffDistance);
                }
            });
#endif
        }
        private void DrawMPImageSettings()
        {
            ...
            gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
            {
                GUIContent = new GUIContent(LocKey.label_mpuikit_settings.Localize()),
                Id = FCU_MenuId.MPUI_SETTINGS_KEY.ToString(),
                Body = () =>
                {
                    fcu.Model.MPUIKIT_Settings.Type = gui.EnumField(new GUIContent(LocKey.label_pui_type.Localize(), ""),
                        fcu.Model.MPUIKIT_Settings.Type);

                    fcu.Model.MPUIKIT_Settings.RaycastTarget = gui.Toggle(new GUIContent(LocKey.label_pui_raycast_target.Localize(), ""),
                        fcu.Model.MPUIKIT_Settings.RaycastTarget);

                    fcu.Model.MPUIKIT_Settings.FalloffDistance = gui.FloatField(new GUIContent(LocKey.label_pui_falloff_distance.Localize(), ""),
                        fcu.Model.MPUIKIT_Settings.FalloffDistance);

                }
            });
#endif
        }
        private void DrawUnityImageSettings()
        {
            gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
            {
                GUIContent = new GUIContent(LocKey.label_unity_image_settings.Localize()),
                Id = FCU_MenuId.UNITY_IMAGE_SETTINGS_KEY.ToString(),
                Body = () =>
                {
                    fcu.Model.UnityImageSettings.Type = gui.EnumField(new GUIContent(LocKey.label_pui_type.Localize(), ""),
                        fcu.Model.UnityImageSettings.Type);

                    fcu.Model.UnityImageSettings.RaycastTarget = gui.Toggle(new GUIContent(LocKey.label_pui_raycast_target.Localize(), ""),
                        fcu.Model.UnityImageSettings.RaycastTarget);
                }
            });
        }
        private void DrawShapes2D_Settings()
        {
            gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
            {
                GUIContent = new GUIContent(LocKey.label_shapes2d_settings.Localize()),
                Id = FCU_MenuId.SHAPES_2D_SETTINGS_KEY.ToString(),
                Body = () =>
                {
                    fcu.Model.Shapes2D_Settings.Type = gui.EnumField(new GUIContent(LocKey.label_pui_type.Localize(), ""),
                        fcu.Model.Shapes2D_Settings.Type);

                    fcu.Model.Shapes2D_Settings.RaycastTarget = gui.Toggle(new GUIContent(LocKey.label_pui_raycast_target.Localize(), ""),
                        fcu.Model.Shapes2D_Settings.RaycastTarget);
                }
            });
        }
        private void DrawDefaultTextSettings()
        {
            gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
            {
                ...
                Body = () =>
                {
                    ...
                    if (gui.Button(new GUIContent(LocKey.label_add_fonts_from_folder.Localize(), LocKey.tooltip_add_fonts_from_folder.Localize())))
                    {
                        fcu.Model.DynamicCoroutine(EditorTools.AddToUnityFontsList(fcu));
                    }
                }
            });
        }
        private void DrawTextMeshProSettings()
        {
            ...
            gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
            {
                ...
                Body = () =>
                {
                    ...
                    if (gui.Button(new GUIContent(LocKey.label_add_fonts_from_folder.Localize(), LocKey.tooltip_add_fonts_from_folder.Localize())))
                    {
                        fcu.Model.DynamicCoroutine(EditorTools.AddToTextMeshFontsList(fcu));
                    }
                }
            });
#endif
                ...
                Body = () =>
                {
                    ...
                    foreach (AssemblyConfig assemblyConfig in FCU_Config.Instance.AssemblyConfigs)
                    {
                        assemblyConfig.Enabled.Value = gui.Toggle(
                            ...
                            new GUIContent(LocKey.label_path.Localize(), LocKey.tooltip_path.Localize()), () =>
                            {
        ...
        private void DrawDebugTools()
        {
            if (fcu.Model.MainSettings.DebugMode)
            {
                gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
                {
                    Id = FCU_MenuId.DEBUG_TOOLS_KEY.ToString(),
                    GUIContent = new GUIContent(LocKey.label_debug_tools.Localize(), LocKey.tooltip_debug_tools.Localize()),
                    Body = () =>
                    {
                        FCU_Config.Instance.LogDefault = gui.Toggle(new GUIContent("LogDefault"),
                            FCU_Config.Instance.LogDefault);

                        FCU_Config.Instance.LogSetTag = gui.Toggle(new GUIContent("LogSetTag"),
                            FCU_Config.Instance.LogSetTag);

                        FCU_Config.Instance.LogIsDownloadable = gui.Toggle(new GUIContent("LogIsDownloadable"),
                            FCU_Config.Instance.LogIsDownloadable);

                        FCU_Config.Instance.LogTransform = gui.Toggle(new GUIContent("LogTransform"),
                            FCU_Config.Instance.LogTransform);

                        GUILayout.Space(gui.NORMAL_SPACE);

                        if (gui.Button(new GUIContent("Button 1")))
                        {
        ...
        private void DrawAssetTools()
        {
            gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
            {
                ...
                GUIContent = new GUIContent(LocKey.label_asset_tools.Localize(), LocKey.tooltip_asset_tools.Localize()),
                Body = () =>
                {
                    gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
                    {
                        Id = FCU_MenuId.REMOVE_UNUSED_SPRITES_KEY.ToString(),
                        GUIContent = new GUIContent(LocKey.label_remove_unused_sprites.Localize(), LocKey.label_remove_unused_sprites.Localize()),
                        Body = () =>
                        {
                            string selectedPath = fcu.Tools.SpritesPath;

                            gui.TextField(
                               new GUIContent(LocKey.label_sprites_path.Localize(), LocKey.tooltip_sprites_path.Localize()),
                               fcu.Tools.SpritesPath,
                               new GUIContent(LocKey.label_change.Localize()),
                               () =>
                               {
                                   string _selectedPath = EditorUtility.OpenFolderPanel(LocKey.label_select_sprites_folder.Localize(), "", "");

                                   if (_selectedPath.IsPathInsideAssetsPath())
                                   {
                            ...
                            fcu.Tools.SpritesPath = selectedPath.ToRelativePath();

                            GUILayout.Space(gui.NORMAL_SPACE);

                            if (gui.Button(new GUIContent(LocKey.label_remove.Localize(), LocKey.tooltip_remove.Localize())))
                            {
                                fcu.Tools.RemoveUnusedSprites_OnClick();
                            }
                        }
                    });
                    ...
                    gui.DrawMenu(ref fcu.Model.SelectableHamburgerItems, new HamburgerItem
                    {
                        Id = FCU_MenuId.CONVERT_FONTS_TO_TEXTMESH_KEY.ToString(),
                        GUIContent = new GUIContent(LocKey.label_convert_fonts_to_textmesh.Localize(), LocKey.tooltip_convert_fonts_to_textmesh.Localize()),
                        Body = () =>
                        {
                            string selectedPath = fcu.Tools.FontsPath;

                            gui.TextField(
                               new GUIContent(LocKey.label_fonts_path.Localize()),
                               fcu.Tools.FontsPath,
                               new GUIContent(LocKey.label_change.Localize()),
                               () =>
                               {
                                   string _selectedPath = EditorUtility.OpenFolderPanel(LocKey.label_select_fonts_folder.Localize(), "", "");
                            ...
                            fcu.Tools.FontsPath = selectedPath.ToRelativePath();

                            GUILayout.Space(gui.NORMAL_SPACE);

                            if (gui.Button(new GUIContent(LocKey.label_convert.Localize(), LocKey.tooltip_convert.Localize())))
                            {
                                EditorTools.ConvertFontsToTextMeshPro_OnClick(fcu);
                            }
                        }
                    });
        ...
        private void Footer()
        {
            ...
            if (gui.Button(new GUIContent(LocKey.label_made_by.Localize()), CustomStyle.BOX_NO_FRAME, 10))
            {
                Application.OpenURL(FCU_Config.Instance.TgLink);
            }
        }
        ...
        private enum FCU_MenuId
        {
            ...
            CUSTOM_PREFABS_KEY,
            DEBUG_TOOLS_KEY,
            REMOVE_UNUSED_SPRITES_KEY,
            CONVERT_FONTS_TO_TEXTMESH_KEY,
            UNITY_IMAGE_SETTINGS_KEY,
            SHAPES_2D_SETTINGS_KEY
        }
